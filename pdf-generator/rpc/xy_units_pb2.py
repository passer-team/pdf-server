...
GenPdfRequest = _reflection.GeneratedProtocolMessageType('GenPdfRequest', (_message.Message,), dict(
...
GenPdfReply = _reflection.GeneratedProtocolMessageType('GenPdfReply', (_message.Message,), dict(
